<div class="col-md-4">
    <div class="subcriber-info">
        <h3>Abunə ol</h3>
        <p>Bizə e-poçt ünvanını göndərərək mütəxəssislərimizdən daha ətraflı məlumat ala bilərsən.</p>
        <div class="subcriber-box">
            <form id="mc-form" class="mc-form" wire:submit.prevent="add_subscriber">
                <div class="newsletter-form">
                    <input type="email" wire:model="email" autocomplete="off" id="mc-email" placeholder="E-poçt ünvanı"
