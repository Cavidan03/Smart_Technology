        ...
        <div class="content">
            <div class="container">
                <div class="page-title">
                    <h2 class="p-3 shadow text-info bg-light">Ümumi Parametrlər</h2>
                </div>
                            ...
                            <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                                ...
                                <form wire:submit.prevent="updateSettings" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($value)
                                        <p class="mt-2">Hazırki {{ ucfirst($key) }}: <img src="{{ asset('storage/uploads/' . $value) }}" width="50" height="50" alt="{{ $key }}"></p>
                                        @endif
                                        @else
