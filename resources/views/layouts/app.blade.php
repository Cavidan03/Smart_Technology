...
<head>
    ...
    <link rel="shortcut icon" href="{{ config('app.url') . 'storage/uploads/' . $settings['logo'] }} " type="image/x-icon" />
...
<body class="clinic_version">
    ...
    <header>
        <div class="header-top wow fadeIn">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><img style="height: 50px; width:50px"
                        src="{{ config('app.url') . 'storage/uploads/' . $settings['logo'] }}" alt="logo image "></a>
                <div class="right-header">
                    <div class="header-info">
                        <div class="info-inner">
                            <span class="iconcont"><a
                                    href="tel:{{ $settings['phone'] ?? '+994 50 820 83 14' }}">{{ $settings['phone'] ?? '+994 50 820 83 14' }}</a></span>
                            <span class="icontop"><img src="{{ config('app.url') }}images/phone-icon.png"
                                    alt="#"></span>
                        </div>
                        <div class="info-inner">
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings['email'] ?? 'nasirovcavidan2003@gmail.com' }}">nasirovcavidan2003@gmail.com</a></span>
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>

                        </div>
                        <div class="info-inner">
                            <span class="iconcont"><a href="#">İş Günlərimiz:
                                    {{ $settings['working_horse'] ?? '08:00 - 18:00' }}</a></span>
                            <span class="icontop"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                        </div>

                        <div class="info-inner">
                            <span class="iconcont" ><a onclick="check_active('Login')" href="{{ url('/login') }}">Admin Panelə Giriş</a></span>
                            <span class="icontop"><i class="fa fa-user" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="{{ url('/') }}"><img style="height: 50px; width:50px"
                                src="{{ 'storage/uploads/' . $settings['logo'] ?? config('app.url') . 'images/logo.png' }}"
                                alt=""></a>
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker" aria-hidden="true"></i>{{ $settings['address'] ?? 'Baku' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $settings['email'] ?? 'nasirovcavidan2003@gmail.com' }}
                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i>{{ $settings['phone'] ?? '+994 50 820 83 14' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
                ...
                <div class="col-md-8">
                    <div class="footer-text">
                        <p>© {{ date('Y') }} <a id="tw" href="{{ url('') }}"
                                target="_blank"></a>Bütün hüquqlar qorunur</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="social">
